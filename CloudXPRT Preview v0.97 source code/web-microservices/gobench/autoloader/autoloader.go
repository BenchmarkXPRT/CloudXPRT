...
func printResults(startTime time.Time) {
	...
	if maxResult.success > 0 {
		table.SetCaption(true, fmt.Sprintf("Best throughput found at %d requests with 95th percentile latency of %s ms",
			maxResult.success, maxResult.elapsed[0]))
	}
