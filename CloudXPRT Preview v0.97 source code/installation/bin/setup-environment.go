...
func main() {
	...
	fmt.Println("Creating hostname backup file\n")
	backupHostname()

	fmt.Println("Setting Date and Time from the Internet\n")
	setDateTime()
	...
	if noProxy {
		...
		if reboot {
			...
			fmt.Println("Please reboot your system manually for proxy changes to take effect!")
		}
	}
}
