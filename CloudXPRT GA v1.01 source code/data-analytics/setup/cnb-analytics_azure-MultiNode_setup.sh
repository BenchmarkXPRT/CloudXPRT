...
kafka_storage_file_basename=$INSTALLATION_DIRECTORY/setup_csp-azure/kafka-storage.yml
zookeeper_storage_file_basename=$INSTALLATION_DIRECTORY/setup_csp-azure/zookeeper-storage.yml
